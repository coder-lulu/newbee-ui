export enum DictEnum {
  ...
  SYS_CONFIG_TYPE = 'system_config_type', // 配置类型
  SYS_DEVICE_TYPE = 'sys_device_type', // 设备类型
  SYS_GRANT_TYPE = 'sys_grant_type', // 授权类型
  SYS_HTTP_REQUEST_METHOD = 'sys_http_request_method',
  SYS_MENU_COMPONENT_TYPE = 'sys_menu_component_type', // 系统菜单组件类型
  ...
  SYS_RPC_SERVICE_LIST = 'sys_rpc_service_list',
