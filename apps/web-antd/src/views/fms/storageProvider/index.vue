...
<template>
  <Page :auto-content-height="true">
    <BasicTable table-title="云存储服务列表">
      <template #toolbar-tools>
        <Space>
          <a-button
            ...
            danger
            type="primary"
            v-access:code="['fms:cloudFile:remove']"
          ...
          <a-button
            type="primary"
            v-access:code="['fms:cloudFile:add']"
            @click="handleAdd"
          >
            {{ $t('pages.common.add') }}
          </a-button>
      ...
      <template #action="{ row }">
        <Space>
          <ghost-button
            v-access:code="['fms:cloudFile:edit']"
